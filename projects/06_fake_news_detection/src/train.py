...
DEFAULT_MODEL_PATH = PROJECT_ROOT / "artifacts" / "fake_news_model.joblib"
...
def main() -> None:
    ...
    parser.add_argument("--headline", type=str, default=None, help="Optional headline to score.")
    parser.add_argument("--body", type=str, default="", help="Optional body text to score.")
    ...
    if args.headline:
        ...
        probabilities = pipeline.predict_proba([article])[0]
        print(f"Prediction for custom article: {prediction}")
