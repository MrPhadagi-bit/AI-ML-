...
DEFAULT_BUNDLE_PATH = ARTIFACTS_DIR / "spam_bundle.joblib"
DEFAULT_REPORT_PATH = ARTIFACTS_DIR / "spam_report.json"
...
def build_candidates() -> dict[str, Pipeline]:
    ...
    return {
        "multinomial_nb": Pipeline(
            steps=[("vectorizer", vectorizer), ("model", MultinomialNB())]
        ),
...
def train(data_path: Path, bundle_path: Path, report_path: Path) -> dict[str, object]:
    ...
    if best_pipeline is None:
        raise RuntimeError("No spam classifiers were available.")
